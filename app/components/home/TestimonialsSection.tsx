...
export default function TestimonialsSection() {
  const testimonials = [
    {
      image: "/images/Faruk Pasha.webp",
      name: "Mr. FARUK PASHA",
      designation:
        "Parent of Midhat Fatimah of Grade IV and Manha Maryam of Grade I (2025-26 Batch)",
    ...
    {
      image: "/images/Ravind Singh.webp",
    ...
    {
      image: "/images/Rahamath P S.webp",
      name: "Mrs. RAHAMATH P S",
      designation:
        "Parent of Rehan Hussain of Grade IX and Rania Hussain of Grade VIII (2025-26 Batch)",
    ...
    {
      image: "/images/Sowmya H N.webp",
      name: "Mrs. SOWMYA H N",
      designation:
        "Parent of Khushi N of Grade I and Abishai N of Grade II (2025-26 Batch)",
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mb-8">
          ...
          <div className="flex flex-col justify-between flex-1">
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                <h3 className="text-xl font-bold text-[#4C231A]">
