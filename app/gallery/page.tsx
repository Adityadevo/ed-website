...
function InfrastructureSection() {
  const infrastructureImages = [
    { src: "/images/infra1.webp", alt: "Playground", rotation: "-rotate-3" },
    { src: "/images/infra2.webp", alt: "Computer Lab", rotation: "rotate-2" },
    { src: "/images/infra3.webp", alt: "Assembly Hall", rotation: "-rotate-1" },
    { src: "/images/ramp.webp", alt: "Science Lab", rotation: "rotate-3" },
    { src: "/images/infra5.webp", alt: "Classroom", rotation: "-rotate-2" },
  ];
  ...
  const prevSlide = () => {
    setCurrentSlide(
      (prev) =>
        (prev - 1 + infrastructureImages.length) % infrastructureImages.length
    );
  };
  ...
  useEffect(() => {
    if (scrollRef.current) {
      const scrollWidth =
        scrollRef.current.scrollWidth / infrastructureImages.length;
...
function ActivitiesSection() {
  const activitiesImages = [
    { src: "/images/ind1.webp", alt: "Student performance" },
    { src: "/images/ind2.webp", alt: "Cultural activity" },
    { src: "/images/ind3.webp", alt: "Group activity" },
    { src: "/images/ind4.webp", alt: "Independence celebration" },
  ];
  ...
  const prevSlide = () => {
    setCurrentSlide(
      (prev) => (prev - 1 + activitiesImages.length) % activitiesImages.length
    );
  };
  ...
  useEffect(() => {
    if (scrollRef.current) {
      const scrollWidth =
        scrollRef.current.scrollWidth / activitiesImages.length;
      scrollRef.current.scrollTo({
        left: scrollWidth * currentSlide,
        behavior: "smooth",
      });
    ...
    <section className="px-4 md:px-8 lg:px-[100px] py-12 md:py-16 bg-[#FAF7EF]">
      ...
      <div className="hidden md:block">
        ...
        <div className="flex gap-6 mb-6 items-start justify-center">
          <div
            className="relative flex-shrink-0 bg-white p-3 shadow-xl"
            style={{ width: "326px", height: "458px" }}
          >
            <div className="relative w-full h-full">
              <Image
        ...
        <div className="flex gap-6 items-start justify-center">
          <div
            className="relative flex-shrink-0 bg-white p-3 shadow-xl"
            style={{ width: "390px", height: "261px" }}
          >
            <div className="relative w-full h-full">
              <Image
                src="/images/ind2.webp"
                alt="Group activity"
                fill
                className="object-cover"
              />
          ...
          <div
            className="relative flex-shrink-0 bg-white p-3 shadow-xl"
            style={{ width: "438px", height: "295px" }}
          >
            <div className="relative w-full h-full">
              <Image
                src="/images/ind3.webp"
          ...
          <div
            className="relative flex-shrink-0 bg-white p-3 shadow-xl"
            style={{ width: "436px", height: "291px" }}
          >
            <div className="relative w-full h-full">
              <Image
                src="/images/ind4.webp"
