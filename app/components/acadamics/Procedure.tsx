        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
          ...
          <div className=" flex flex-col gap-4">
            ...
            <p className="text-base md:text-lg text-gray-800 leading-relaxed">
              ...
              welcomes students to an enriching and joyful learning experience.
              The admission procedure is completely transparent and has been
              designed to ensure a suitable fit between what the parents and
              children expect from the school.
            </p>

            <p className="text-base md:text-lg text-gray-800 leading-relaxed">
              Age eligibility for Grade I as per the government norms is
              mandatorily completion of 6 years as on 1<sup>st</sup> June of
              that particular academic year.
            </p>

            <p className="text-base md:text-lg text-gray-800 leading-relaxed">
              Parents applying for admission will be required to fill out an
              application form which shall be given at the school premises only.
              A written entrance test will be given in the school campus from
              Grade UKG to Grade X under the observation of a teacher to assess
              his/her ability for higher classes. There will no formal entrance
              test for Nursery and LKG.
            </p>
