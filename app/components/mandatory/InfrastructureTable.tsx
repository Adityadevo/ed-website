...
const defaultInfra: InfraRow[] = [
  { sl: 1, label: "Total Campus Area (sq m)", value: <span className="font-semibold">6117</span> },
  { sl: 2, label: "No. & Size of Classrooms", value: <span className="font-semibold">54, 25X25</span> },
  { sl: 3, label: "No. & Size of Laboratories", value: <span className="font-semibold">4, 25X25</span> },
  ...
  { sl: 7, label: "Link of YouTube Video of School Inspection", value: <a className="text-[#A64253] font-semibold hover:underline" href="https://youtu.be/pY-qc-ybe28?si=GpG-uDGOtv1vUhEH">Click here for Video</a> },
];
