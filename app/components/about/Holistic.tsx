      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-16">
        <div className="max-w-7xl mx-auto flex flex-col gap-12">
          ...
          <p className="text-base md:text-lg text-gray-800 text-center leading-relaxed max-w-5xl mx-auto">
            PPS offers a comprehensive learning programme that extends far
            beyond the confines of a classroom. Students have countless
            opportunities to assimilate knowledge, discover hidden talents,
            follow dreams and grow into well-rounded individuals.
          </p>
        </div>
